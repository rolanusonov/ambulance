                    ...
                    <div className="connection__our">
                        ...
                        <div className="connection__our__contact">
                            <div className="connection__our__contact__logos">
                                <svg className="connection__our__contact__logos__cvg"  viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div className="connection__our__contact__logos">
                                <svg className="connection__our__contact__logos__cvg2"  viewBox="0 0 28 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <p className="connection__our__contact__logos__title">Кыргызстан, г. Бишкек, ул. Ахунбаева 2/1</p>
                            </div>
                            <div className="connection__our__contact__logos">
                                <svg className="connection__our__contact__logos__cvg"  viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd"
                                ...
                                <a href="" className="connection__our__contact__logos__titles">Наш WhatsApp</a>
                            </div>
                            <div className="connection__our__contact__logos">
                                <svg className="connection__our__contact__logos__cvg"  viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <a href="" className="connection__our__contact__logos__titles">Наш Instagram</a>
                            </div>
                            <div style={{width:"100%", display:"flex",justifyContent:"center"}}>
                                <button className="connection__our__contact__btn">
                                    <a className="connection__our__contact__btn__a " href="tel:+996501482929">Вызвать</a>
                                </button>
                            </div>
                        </div>
                            <iframe className="connection__our__google" src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d5848.508298798211!2d74.5708881!3d42.8674796!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sru!2skg!4v1660320338821!5m2!1sru!2skg"
