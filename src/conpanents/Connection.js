                ...
                <div className="connection">
                    ...
                    <div className="connection__our">
                        ...
                        <div className="connection__our__contact" data-aos="flip-right"  >
                            <a href="tel:+996701103163" className="connection__our__contact__logos">
                                ...
                                <a className="connection__our__contact__logos__title" href=" ">+996
                                    (701) 103 163</a>
                            </a>
                            ...
                            <a href=" https://wa.me/+996501482929" className="connection__our__contact__logos">
                                <svg className="connection__our__contact__logos__cvg" viewBox="0 0 28 27" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd"
                            ...
                            <div style={{width: "100%", display: "flex", justifyContent: "center"}}>
                                <button className="connection__our__contact__btn">
                                    <a className="connection__our__contact__btn__a "
                                       href="tel:+996501482929">Вызвать</a>
                                </button>
                            </div>
                        </div>
